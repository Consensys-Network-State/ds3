...
import { RootProps } from '@rn-primitives/radio-group';

interface RadioGroupFieldProps extends RootProps {
  label?: string;
  description?: string;
  error?: string;
}
...
const RadioGroupFieldItem: React.FC<RadioGroupFieldItemProps> = ({ value, onLabelPress }) => {
  return (
